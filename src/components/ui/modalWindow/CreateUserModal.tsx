...
import { TOAST_MESSAGE_SUCCESS_CREATE_USER } from "@/constants/toastMessages/success";
...
import { BUTTON_CREATE_TEXT } from "@/constants/text/buttons";
...
const CreateUserModal = ({ reloadUsers, setShow }: CreateUserModalProps) => {
  ...
  >({
    ...
    onSuccess: () => {
      ToastEmitter.success(TOAST_MESSAGE_SUCCESS_CREATE_USER);
      reloadUsers();
      setShow(false);
    },
    onError: (error) => {
