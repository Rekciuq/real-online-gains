...
INSERT INTO "new_User" ("bio", "birthDate", "email", "firstName", "gender", "id", "isBlocked", "lastName", "password", "roleId") SELECT "bio", "birthDate", "email", "firstName", "gender", "id", "isBlocked", "lastName", "password", "roleId" FROM "User";
DROP TABLE "User";
